...
export interface LineageContinuityProof { readonly intentDigest:string; readonly projectId:string; readonly lineageId:string; readonly checkpointDigest:string; readonly handoffDigest:string; readonly readinessCertificateDigest:string; readonly valid:boolean; readonly mismatch:'NONE'|'PROJECT'|'LINEAGE'|'CHECKPOINT'|'HANDOFF'; readonly proofDigest:string; }
