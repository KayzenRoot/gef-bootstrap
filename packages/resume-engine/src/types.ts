...
export interface ResumeIntentCapsuleInput { readonly resumeId:string; readonly projectId:string; readonly expectedLineageId:string; readonly expectedCheckpointDigest:string; readonly requestedNextAction:string|null; }
export interface ResumeIntentCapsule extends ResumeIntentCapsuleInput { readonly intentDigest:string; }

export interface LineageContinuityProof { readonly intentDigest:string; readonly projectId:string; readonly lineageId:string; readonly checkpointDigest:string; readonly handoffDigest:string; readonly valid:boolean; readonly mismatch:'NONE'|'PROJECT'|'LINEAGE'|'CHECKPOINT'|'HANDOFF'; readonly proofDigest:string; }
export interface ResumeAuthorityBoundary { readonly intentDigest:string; readonly checkpointDigest:string; readonly handoffDigest:string; readonly canonicalNextAction:string; readonly requestedNextAction:string|null; readonly authorized:boolean; readonly reason:string; readonly boundaryDigest:string; }
...
export interface ResumeMinimumSufficientContext { readonly checkpointDigest:string; readonly handoffDigest:string; readonly nextLegalAction:string; readonly activeClaimIds:readonly string[]; readonly requiredAuthorityBindingIds:readonly string[]; readonly evidenceRefs:readonly string[]; readonly blockerRefs:readonly string[]; readonly contextRefs:readonly ResumeContextRef[]; readonly contextDigest:string; }
...
export interface ResumeReadPlan { readonly checkpointDigest:string; readonly handoffDigest:string; readonly contextDigest:string; readonly steps:readonly ResumeReadPlanStep[]; readonly maxReads:number; readonly expansionRequired:boolean; readonly planDigest:string; }
...
export interface ResumeObservation { readonly projectId:string; readonly lineageId:string; readonly checkpointDigest:string|null; readonly policyBindingDigest:string|null; readonly authorityIdentities:Readonly<Record<string,string|undefined>>; readonly claimStates:Readonly<Record<string,string|undefined>>; }
...
export interface ResumeDriftVector { readonly checkpointDigest:string; readonly entries:readonly ResumeDriftEntry[]; readonly hasMaterialDrift:boolean; readonly hasUnknown:boolean; readonly vectorDigest:string; }
...
export interface OrphanWorkReport { readonly checkpointDigest:string; readonly findings:readonly OrphanWorkFinding[]; readonly orphanWorkIds:readonly string[]; readonly reportDigest:string; }
...
export interface ResumeConflictQuarantine { readonly checkpointDigest:string; readonly driftVectorDigest:string; readonly orphanReportDigest:string; readonly conversationResultDigest:string; readonly entries:readonly ResumeConflictEntry[]; readonly quarantineDigest:string; }

export interface ResumeReceipt { readonly resumeId:string; readonly status:ResumeStatus; readonly projectId:string; readonly lineageId:string; readonly checkpointDigest:string; readonly handoffDigest:string; readonly nextAction:string|null; readonly decisionDigest:string; readonly readPlanDigest:string; readonly driftVectorDigest:string; readonly orphanReportDigest:string; readonly quarantineDigest:string; readonly receiptDigest:string; }
