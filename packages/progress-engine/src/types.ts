...
export interface ProgressInvalidationVector{readonly changedBindingDigests:readonly string[];readonly affectedUnitIds:readonly string[];readonly widened:boolean;readonly reasonCodes:readonly string[];readonly vectorDigest:string;}
...
export interface CreditRetractionTransaction{readonly beforeVectorDigest:string;readonly afterVectorDigest:string;readonly retractedUnitIds:readonly string[];readonly beforeExact:ExactFraction;readonly afterExact:ExactFraction;readonly transactionDigest:string;}
...
export interface ProgressDriftReport{readonly state:DriftState;readonly staleSubjects:readonly string[];readonly reportDigest:string;}
export interface DenominatorDriftDecision{readonly sameEpoch:boolean;readonly comparisonAllowed:boolean;readonly snapshotReusable:boolean;readonly reason:string;readonly decisionDigest:string;}
...
export interface ProgressRegressionReceipt{readonly beforeSnapshotDigest:string;readonly afterSnapshotDigest:string;readonly beforeExact:ExactFraction;readonly afterExact:ExactFraction;readonly retractedUnitIds:readonly string[];readonly reasonCodes:readonly string[];readonly receiptDigest:string;}
...
export interface ProgressSnapshotCapsule{readonly projectId:string;readonly lineageDigest:string;readonly manifestDigest:string;readonly epochId:string;readonly scopeDigest:string;readonly dodDigest:string;readonly evidenceSetDigest:string;readonly exact:ExactFraction;readonly completeness:ProgressCompletenessEnvelope;readonly creditDigests:readonly string[];readonly graphDigest:string;readonly predecessorSemanticDigest:string|null;readonly semanticDigest:string;readonly snapshotDigest:string;}
export interface ProgressIntegrityReceipt{readonly snapshotDigest:string;readonly manifestDigest:string;readonly graphDigest:string;readonly creditDigests:readonly string[];readonly recomputedExact:ExactFraction;readonly valid:boolean;readonly receiptDigest:string;}
export interface DelegatedProgressMetricHandoff{readonly metricKey:'project_completion';readonly owner:'M21_PROGRESS';readonly availability:CompletenessState;readonly exactNumerator:number;readonly exactDenominator:number;readonly presentationBasisPoints:number|null;readonly sourceIdentityDigest:string;readonly validityBindingDigest:string;readonly handoffDigest:string;}
...
export interface ProgressStalenessReport{readonly stale:boolean;readonly staleSubjects:readonly string[];readonly reportDigest:string;}
