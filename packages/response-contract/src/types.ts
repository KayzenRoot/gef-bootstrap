...
export interface DelegatedMetricClaim{readonly metricKey:string;readonly owner:MetricOwner;readonly availability:MetricAvailability;readonly scalarValue:number|string|null;readonly rangeValue:MetricRange|null;readonly unit:string|null;readonly precision:number|null;readonly sourceIdentityDigest:string;readonly validityBindingDigest:string;readonly baselineDigest:string|null;readonly confidence:ConfidenceEnvelope|null;readonly claimDigest:string;}
...
export interface MachineResponseEnvelope{readonly schema:ResponseSchemaEnvelope;readonly projectId:string;readonly responseKind:string;readonly checkpointBindingDigest:string;readonly resumeBindingDigest:string;readonly registryBindingDigest:string;readonly fields:readonly SourceBoundFieldClaim[];readonly metrics:readonly DelegatedMetricClaim[];readonly blockers:readonly BlockerProjection[];readonly conflicts:readonly StateConflictWitness[];readonly nextAction:NextNecessaryActionCapsule;readonly verdict:VerdictDecision;readonly provenanceIndex:ResponseProvenanceIndex;readonly semanticDigest:string;readonly machineDigest:string;}
...
export interface ResponseBindingObservation{readonly checkpointBindingDigest:string;readonly resumeBindingDigest:string;readonly registryBindingDigest:string;readonly metricValidityBindings?:Readonly<Record<string,string>>|undefined;readonly fieldValidityBindings?:Readonly<Record<string,string>>|undefined;}
